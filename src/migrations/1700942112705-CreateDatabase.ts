...
export class CreateDatabase1700942112705 implements MigrationInterface {
    name = 'CreateDatabase1700942112705'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "emergency_contacts" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "name" character varying(128) NOT NULL, "telephone" character varying(13) NOT NULL, "userId" uuid, CONSTRAINT "REL_9b9bb7f85035305c3dee924d22" UNIQUE ("userId"), CONSTRAINT "PK_8be191845b6fca1c4e5ba5bd7d1" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TYPE "public"."users_role_enum" AS ENUM('guest', 'manager', 'attendant')`);
        await queryRunner.query(`CREATE TABLE "users" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "name" character varying(128) NOT NULL, "cpf" character varying(11) NOT NULL, "password" character varying(128) NOT NULL, "email" character varying(128) NOT NULL, "telephone" character varying(13) NOT NULL, "nationality" character varying(50) NOT NULL, "room_key" character varying(100), "role" "public"."users_role_enum" NOT NULL DEFAULT 'guest', "createdAt" date NOT NULL DEFAULT now(), "updatedAt" date NOT NULL DEFAULT now(), CONSTRAINT "UQ_230b925048540454c8b4c481e1c" UNIQUE ("cpf"), CONSTRAINT "UQ_97672ac88f789774dd47f7c8be3" UNIQUE ("email"), CONSTRAINT "PK_a3ffb1c0c8416b9fc6f907b7433" PRIMARY KEY ("id"))`);
